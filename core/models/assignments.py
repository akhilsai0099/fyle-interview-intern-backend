...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(((assignment.teacher_id is not None) and (assignment.state == AssignmentStateEnum.SUBMITTED) or ((auth_principal.principal_id is not None) and assignment.state != AssignmentStateEnum.DRAFT) ), 'Only a submitted assignment can be graded')
